...
if __name__ == "__main__":
    ...
    # should proxy support be added?
    if proxy:
        print(proxy)

    body = "It feels like: "+ conditions.feelslike_f + " currently, and it is currently: " + conditions.weather
    client = TwilioRestClient(account_sid, auth_token)
    message = client.messages.create(to=to_number,from_=twilio_number, body=body)
